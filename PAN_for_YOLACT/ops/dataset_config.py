...
ROOT_DATASET = '/home/michal/code/bachelor_thesis/yolact-camera/testset/rgb'
...
def return_somethingv2(modality):
    filename_categories = 9
    if modality in ['RGB', 'PA', 'Lite']:
        root_data = ROOT_DATASET
        filename_imglist_train = '/home/michal/code/bachelor_thesis/yolact-camera/testset/dataset8.txt'
        filename_imglist_val = '/home/michal/code/bachelor_thesis/yolact-camera/testset/valid8.txt'
        prefix = '{:06d}.jpg'
    elif modality == 'Flow':
